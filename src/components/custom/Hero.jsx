        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600">
                Get insider tips on transportation, weather, and cultural norms for each destination.
              </p>
            </div>
      ...
      <section className="bg-[#f56551] py-16 px-4 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            "NepYatra saved me hours of research and helped me discover places I never would have found on my own." - Happy Traveler
          </p>
          <Link to="/create-trip">
